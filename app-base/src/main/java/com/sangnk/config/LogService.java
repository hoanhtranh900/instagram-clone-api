...
public class LogService {
    ...
    * */
    ...
    @Before("within(com.sangnk.enpoint.*)")
    public void before(JoinPoint joinPoint){
        //log.info(" Before called " + joinPoint.toString());
    }

    @AfterThrowing("within(com.sangnk.enpoint.*)")
    public void AfterThrowing(JoinPoint joinPoint){
        //log.info(" AfterThrowing called " + joinPoint.toString());
    }

    @AfterReturning("within(com.sangnk.enpoint.*)")
    public void AfterReturning(JoinPoint joinPoint){
        //log.info(" AfterReturning called " + joinPoint.toString());
    }

    @After("within(com.sangnk.enpoint.*)")
    public void after(JoinPoint joinPoint){
        //log.info(" After called " + joinPoint.toString());
    }

    @Around("@annotation(com.sangnk.core.config.TrackLog)") // around by annotation
